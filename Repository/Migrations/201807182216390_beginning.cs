namespace Repository.Migrations
{
    ...
    public partial class beginning : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AdCategory", "CategoryId", "dbo.Category");
            DropForeignKey("dbo.Advertisement", "UserID", "dbo.AspNetUsers");
            DropForeignKey("dbo.AdCategory", "Advertisement_Id", "dbo.Advertisement");
            ...
            DropIndex("dbo.AdCategory", new[] { "Advertisement_Id" });
            DropIndex("dbo.AdCategory", new[] { "CategoryId" });
